  ...
  return (
    <div className="bg-[#252934] lg:h-screen">
      <div className="text-center text-white space-y-6 pt-20">
        <h1 className=" text-4xl relative z-0 inline-block px-1 font-semibold uppercase after:absolute after:-bottom-6 after:right-0  after:h-1 after:w-20 after:mr-12 after:-translate-y-2 after:bg-white after:content-['']">
          Contact
        </h1>
        ...
        <div className=" px-10 lg:col-span-2">
          <form ref={form} onSubmit={sendEmail}>
            <input
              type="text"
              name="to_name"
              className=" lg:w-[293px] md:w-[244px] w-3/4 px-2 shadow-lg rounded  py-4 my-3 placeholder:ml-0 "
              placeholder="Name"
              required
            />
            <input
              type="email"
              name="from_name"
              className=" lg:w-[293px] md:w-[244px] w-3/4 md:ml-6 px-2 my-5 py-4 shadow-lg rounded lg:my-4 lg:ml-3"
              placeholder="Email"
              required
            />
            <input
              ...
              required
              placeholder="Subject"
              className=" w-3/4 sm: px-2  py-4 my-2 shadow rounded"
            />
            <textarea
              name="message"
              className="  w-3/4 px-2 py-5 shadow rounded my-3"
              placeholder="Message"
              required
            />
            <br />
