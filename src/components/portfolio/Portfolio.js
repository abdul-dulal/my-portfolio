...
const Portfolio = () => {
  ...
  return (
    <div id="portfolio" className="  bg-[#111827] mt-14 pb-20">
      ...
      <div className="flex lg:gap-10 uppercase text-[11px] ml-5  py-14 lg:px-48 lg:text-xl md:px-14 md:text-xl  font-bold">
        <button
          onClick={() => setShow("all")}
          className={`md:px-8 lg:px-8  px-0 t  ${
